...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <%
                if (null != loginUser && (loginUser.getAuthority() == 1 || loginUser.getAuthority() == 2)){
            %>
                <li class="nav-item">
                    <a class="nav-link" href="<%=path%>/admin/home/show">Back To Admin</a>
                </li>
            <%
                }
            %>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=path%>/fore/home/show">Home</a>
            </li>
                <li class="nav-item">
                    <a class="nav-link" href="<%=path%>/fore/home/recommend">Recommend</a>
                </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkA" role="button"
                   data-bs-toggle="dropdown" aria-expanded="false">
                    Buyer
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="<%=path%>/fore/buyer/order/list">Check What I Bought</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="<%=path%>/fore/seller/order/list">Shipments && History Order</a>
                    </li>
                    <li><a class="dropdown-item" href="<%=path%>/fore/seller/goods/list">Check My Goods For Sale</a>
                    </li>
                    <li><a class="dropdown-item" href="<%=path%>/fore/page/add/goods">Sell My Items</a></li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLinkC" role="button"
                   data-bs-toggle="dropdown" aria-expanded="false">
                    Account
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item" href="<%=path%>/fore/user/show/about-me">About Me</a></li>
                    <li><a class="dropdown-item" href="<%=path%>/fore/user/edit/account">Edit My Account</a></li>
                    <%--<li><a class="dropdown-item" href="<%=path%>/fore/user/edit/password">Forget My Password</a></li>--%>
                    <li><a class="dropdown-item" href="<%=path%>/fore/user/tracker/list">My Favourite</a></li>
                    <li><a class="dropdown-item" href="<%=path%>/fore/user/history/list">My Footprint</a></li>
                </ul>
            </li>
        </ul>
    </div>

    <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" action="${pageContext.request.contextPath}/fore/home/search">
        <input name="keyword" type="search" class="form-control form-control-dark" placeholder="Search..." aria-label="Search">
    </form>
    ...
    <div class="text-end">
        <a href="<%=path%>/fore/page/login">
            <button type="button" class="btn btn-outline-primary me-2">Login</button>
        </a>
        <a href="<%=path%>/fore/page/register">
            <button type="button" class="btn btn-primary">Sign-up</button>
        </a>
        <a href="<%=path%>/fore/user/logout">
