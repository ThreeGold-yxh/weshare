...
<div class="container goodsAddForm">
    ...
    <form method="post" action="${pageContext.request.contextPath}/fore/seller/goods/deal-with-edit/${requestScope.goods.wsGoodsId}" class="registerForm" novalidate enctype="multipart/form-data">
        ...
        <div class="form-goods" style="text-align: center">
            <h2 class="form-goods-heading">Edit My Item</h2>
            ...
            <input name="wsGoodsName" type="text"
                   ...
                   value="${requestScope.goods.wsGoodsName}">
            ...
            <input name="wsGoodsPrice" type="number"
                   ...
                   max="10000"
                   step="0.01"
                   value="${requestScope.goods.wsGoodsPrice}">
            ...
            <input name="wsGoodsAmount" type="number"
                   ...
                   min="0"
                   max="10000"
                   value="${requestScope.goods.wsGoodsAmount}">
            ...
            <select name="wsGoodsCategoryId"
                ...
                <option selected value="${requestScope.selectedCategory.wsCategoryId}">${requestScope.selectedCategory.wsCategoryName}</option>
            ...
            <textarea name="wsGoodsDescription"
                      ...
                      style="height: 150px">${requestScope.goods.wsGoodsDescription}</textarea>
            ...
            <img src="<%=basePath%>${requestScope.goods.wsGoodsImage}" alt="" id="goods_add_img">
            <%--释放--%>

            <input style="visibility: hidden" name="wsGoodsImageOriginal" id="exampleInputProductUpLoadFileOriginal" type="file" accept="image/*" value="${requestScope.goods.wsGoodsImage}"/>
