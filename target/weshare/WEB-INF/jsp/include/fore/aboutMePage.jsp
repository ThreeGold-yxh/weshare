...
<div style="width: 40%; margin-left: 30%; margin-right: 30%; height: 320px; border: 2px solid black; margin-top: 5%; background-color: honeydew; position: relative">
    ...
    <h4 style="position: absolute; z-index: 2; left: 10%; top: 82%; color: seagreen;">Credit:</h4>
    <h4 style="position: absolute; z-index: 2; left: 40%; top: 82%; color: black;">${requestScope.user.wsUserCredit}</h4>
