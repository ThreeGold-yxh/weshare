...
<div id="container" style="margin-top: 20px">
    ...
    <div class="col-md-5 col-sm-5 col-xs-5 ps-3 pt-3" style="float: right ; height: 450px; margin-right: 10%; text-align: center">
        ...
        <div style="word-wrap:break-word; word-break:break-all; height: 200px; margin-right: 5%; border: 2px solid; border-color: black; vertical-align: middle">${goods.wsGoodsDescription}</div>
    </div>
    ...
    <h3 style="color: #1a1e21; text-align: center">Are you sure to pay?</h3>
    ...
    <div style="text-align: center">
        <span><a href="${pageContext.request.contextPath}/fore/buyer/order/add?id=${goods.wsGoodsId}" class="btn btn-primary mx-4 my-3">confirm to pay</a></span>
        <%--<span><a href="#" class="btn m-2">      </a></span>--%>
        <span><a href="${pageContext.request.session.getAttribute("previouspath")}" class="btn btn-danger mx-4 my-3">quit</a></span>
    </div>
